...
exports.RequestsModule = RequestsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([request_entity_1.TrackingRequest, request_log_entity_1.RequestLog, document_request_entity_1.DocumentRequest, document_entity_1.Document])
        ],
