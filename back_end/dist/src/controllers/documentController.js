...
exports.downloadDocument = exports.getUserReports = exports.submitReport = exports.getDocumentRequests = exports.submitDocumentRequest = exports.getDocumentsByUserId = exports.uploadAndSaveDocument = exports.getUserDocuments = exports.verifyDocument = exports.getDashboardStats = void 0;
...
// ─── Helpers ──────────────────────────────────────────────────────────────────
function generateVerificationHash(content) {
    return crypto_1.default.createHash('sha256').update(content + Date.now()).digest('hex').slice(0, 16);
}
// ─── Controllers ──────────────────────────────────────────────────────────────
const getDashboardStats = async (req, res) => {
    try {
        ...
        const reqRepo = database_1.AppDataSource.getRepository(Request_1.Request);
        const repRepo = database_1.AppDataSource.getRepository(Report_1.Report);
...
const verifyDocument = async (req, res) => {
    try {
        const { id } = req.params;
        const repo = database_1.AppDataSource.getRepository(Document_1.Document);
...
const uploadAndSaveDocument = async (req, res) => {
    try {
        if (!req.user)
            return res.status(401).json({ status: 'fail', message: 'Unauthorized' });
        if (!req.file)
...
exports.uploadAndSaveDocument = uploadAndSaveDocument;
...
const submitDocumentRequest = async (req, res) => {
    try {
        ...
        const repo = database_1.AppDataSource.getRepository(Request_1.Request);
